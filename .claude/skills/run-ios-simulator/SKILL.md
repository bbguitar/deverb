...
open -a Simulator
xcrun simctl boot $UDID 2>/dev/null || true
xcrun simctl install $UDID ~/Library/Developer/Xcode/DerivedData/Deverb-*/Build/Products/Debug-iphonesimulator/Deverb.app
xcrun simctl launch $UDID com.AcmeInc.Deverb
```
